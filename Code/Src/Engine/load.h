...
void Create_Objs ( ) {
	...
	Manager::UI_Object_Load ( "DEATH", "palle", "", "death_record", {0,0}, {1000,1000}, nullptr, 6 )->Set_Active(false);
...
void Create_Scenes ( ) {
	...
	Manager::Scene_Get ( "main" )->Add_UI_Object ( Manager::UI_Object_Get( "DEATH" ) );
